...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/solitary-butterfly-35cd
```

A live public deployment of this template is available at [https://solitary-butterfly-35cd.templates.workers.dev](https://solitary-butterfly-35cd.templates.workers.dev)
